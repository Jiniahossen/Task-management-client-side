...
const Peoples = () => {
    return (
        <div className="my-20">
            <h1 className="text-4xl mb-2 font-serif text-center">what type of people are using this website</h1>
            <p className="text-sm text-gray-400 font-serif text-center mb-16"> Build your brand or business by becoming a TeamWork Partner.</p>
            <div className="grid mb-8 border font-serif border-gray-200 rounded-lg shadow-sm dark:border-gray-700 md:mb-12 md:grid-cols-2 bg-white dark:bg-gray-800">
